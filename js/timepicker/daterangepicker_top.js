    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                  ...
                  '</div>' +
                  '<div class="NT_Noticeword">'+
                     '<span>温馨提醒：<br/>查询期间为近6个月。'+
                   '</div>'+
                '</div>' +
              '</div>';
    ...
    DateRangePicker.prototype = {
        ...
        move: function () {
            ...
            if (this.opens == 'left') {
                ...
                this.container.css({
                    top:  this.element.offset().top /2 - this.element.outerHeight()*2.5,
                    left: 20,
                    right: 'auto'
                });
//                top: this.element.offset().top + this.element.outerHeight() - parentOffset.top,left: this.element.offset().left - parentOffset.left,
